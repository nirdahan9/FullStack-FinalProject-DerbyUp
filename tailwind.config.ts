...
export default {
  ...
  prefix: "",
  // On touch devices, hover: styles caused the first tap to "stick" the hover
  // state and only the second tap to fire the click (back button needed two taps
  // to leave the notifications page). This flag wraps every hover: utility in
  // @media (hover: hover), so touch devices skip the hover state entirely.
  future: {
